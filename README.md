# DataVis Assignment 3

This repository contains the bare-bones files to start up and solve the third assignment of the DataVis course at TU Dresden. 

Both required datasets are in `/data`, namely: [`airports.csv`](./data/airports.csv) and [`flights-airport-5000plus.csv`](./data/flights-airport-5000plus.csv).  
